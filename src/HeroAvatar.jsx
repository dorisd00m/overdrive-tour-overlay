    ...
    return(
        <>
            ...
            <div className={clsx((side === 'left' ? 'left-side' : 'right-side'),'relative w-40 h-40 bg-gray-800 clip-parallelogram flex items-center justify-center text-white font-bold overflow-hidden',className)}>
                <img src={CurrentData && '/overdrive-tour-overlay/char/'+CurrentData.src || '/overdrive-tour-overlay/char/XiangliYao.gif'} className="absolute w-full h-full object-cover" style={{objectPosition: `${CurrentData?.x}% ${CurrentData?.y}%` || '60% 30%' }} alt="" />
